...
import { setLocalId, setUserCel, setUserEmail, setUserLastName } from "../../Store/Slices/userSlice";
...
const SignUpScreen = ({ navigation }) => {
    ...
    const saveData = async (localId) => {
        try {
            await UpdateName({ localId, name }).unwrap();
            await UpdateLastName({ localId, lastname: lastName }).unwrap();
            await UpdateCel({ localId, cel }).unwrap();
        } catch (error) {
            console.log(error);
        }
    };
    ...
    return (
        <View style={styles.conatiner}>
            ...
            {/*Celular*/}
            <TextInput onChangeText={(text) => setCel(text)} placeholder="Celular" style={styles.input} />
